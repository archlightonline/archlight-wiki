...
const { extractAllPages, extractConceptPages, extractClassesPage, extractAddonsPage } = await import('./extract-content.mjs');
...
const conceptPages = [...extractConceptPages(), ...extractClassesPage(), ...extractAddonsPage()];
